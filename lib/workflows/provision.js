...
/* global napiUrl, ufdsUrl, ufdsDn, ufdsPassword,cnapiUrl */
/* global fwapiUrl,imgapiUrl,sapiUrl */
...
function preparePayload(job, cb) {
    ...
    // XXX IQVIA XX
    if (typeof params.tags !== 'undefined' && typeof params.tags["delegate_dataset"] !== 'undefined') {
        if (params.tags["delegate_dataset"] === "true" || params.tags["delegate_dataset"] === true) {
            payload['delegate_dataset'] = true;
        }
    }
    ...
    // IQVIA XXX Add Snapshot Limit
    keys.push('zfs_snapshot_limit');
    ...
    // IQVIA XXX Add Snapshot Limit
    payload['zfs_snapshot_limit'] = 1000;
